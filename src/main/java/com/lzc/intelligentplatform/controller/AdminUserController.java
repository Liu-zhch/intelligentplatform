...
public class AdminUserController {
    ...
    public ResponseMessage addAdminUser(@RequestBody @Validated AdminUser user) {
    ...
    public ResponseMessage getAdminUser(AdminListRequest request){
        ResponseMessage message = new ResponseMessage();
        try {
            log.info("user:{}", JSONObject.toJSONString(request));
            message.setData(userService.getAdminUser(request));
            return message;
        } catch (Exception e) {
            ExceptionHandle.handle(e, message);
        }
    ...
    public ResponseMessage getAdminUser(@RequestBody String ids){
        ResponseMessage message = new ResponseMessage();
        try {
            ...
            userService.delAdminUser(idSet);
            return message;
        } catch (Exception e) {
            ExceptionHandle.handle(e, message);
        }
